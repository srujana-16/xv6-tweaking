...
int main(int argc, char *argv[])
{
  ...
  16:	82e58593          	addi	a1,a1,-2002 # 840 <malloc+0xee>
  1a:	4509                	li	a0,2
  ...
  36:	1d2080e7          	jalr	466(ra) # 204 <atoi>
  3a:	892a                	mv	s2,a0
    int pid = atoi(argv[2]);
  3c:	6888                	ld	a0,16(s1)
  3e:	00000097          	auipc	ra,0x0
  42:	1c6080e7          	jalr	454(ra) # 204 <atoi>
  46:	84aa                	mv	s1,a0
    int prev_priority = set_priority(priority, pid);
  48:	85aa                	mv	a1,a0
  4a:	854a                	mv	a0,s2
  4c:	00000097          	auipc	ra,0x0
  50:	368080e7          	jalr	872(ra) # 3b4 <set_priority>
  54:	862a                	mv	a2,a0
    printf("setpriority: Priority of %d changed from %d to %d.\n", pid, prev_priority, priority);
  56:	86ca                	mv	a3,s2
  58:	85a6                	mv	a1,s1
  5a:	00001517          	auipc	a0,0x1
  5e:	81e50513          	addi	a0,a0,-2018 # 878 <malloc+0x126>
  62:	00000097          	auipc	ra,0x0
  66:	632080e7          	jalr	1586(ra) # 694 <printf>
    exit(0);  
  6a:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 404:	4b850513          	addi	a0,a0,1208 # 8b8 <digits>
 408:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 610:	2a490913          	addi	s2,s2,676 # 8b0 <malloc+0x15e>
        while(*s != 0){
