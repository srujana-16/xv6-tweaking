...
int main() {
  ...
  6c:	80850513          	addi	a0,a0,-2040 # 870 <malloc+0xe4>
  70:	00000097          	auipc	ra,0x0
  74:	65e080e7          	jalr	1630(ra) # 6ce <printf>
  exit(0);
  78:	4501                	li	a0,0
  ...
  94:	34e080e7          	jalr	846(ra) # 3de <waitx>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 43e:	45e50513          	addi	a0,a0,1118 # 898 <digits>
 442:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 50a:	392b8b93          	addi	s7,s7,914 # 898 <digits>
 ...
 64a:	24a90913          	addi	s2,s2,586 # 890 <malloc+0x104>
        while(*s != 0){
